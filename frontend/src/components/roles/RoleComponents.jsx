...
import { createRole, updateRole, roleById } from '../../services/RoleService';
            ...
            <div className='container' style={styles.container}>
                <div className='row'>
                    <div style={styles.card}>
                        <h2 className='text-center'>{id ? 'Update Role' : 'Add Role'}</h2>
                        <div style={styles.cardBody}>
                            <form style={styles.form}>
                                ...
                                <button type='submit' className='btn btn-success' style={styles.button} onClick={saveRole}>Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
